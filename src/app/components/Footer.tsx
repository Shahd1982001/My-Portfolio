        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <a href="https://wa.me/218918701397" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-white/10 hover:bg-green-600 transition">
              ...
              <a href="tel:+218918701397" className="p-2 rounded-lg bg-white/10 hover:bg-blue-600 transition">
